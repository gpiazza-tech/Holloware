...
namespace Holloware
{
	...
	{
		DrawTexture(properties, s_Data.WhiteSubTexture);
	}

	void Renderer2D::DrawRotatedQuad(const QuadProperties& properties, float rotation)
	{
		DrawRotatedTexture(properties, rotation, s_Data.WhiteSubTexture);
	}

	void Renderer2D::DrawTexture(const QuadProperties& properties, const Ref<SubTexture2D>& subTexture)
	{
		HW_PROFILE_FUNCTION();
	...
	void Renderer2D::DrawRotatedTexture(const QuadProperties& properties, float rotation, const Ref<SubTexture2D>& subTexture)
	{
		HW_PROFILE_FUNCTION();
